        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='meishi'">
                    <el-form-item class="select" v-if="type!='info'"  label="美食信息" prop="meishiId">
                        <el-select v-model="ruleForm.meishiId" :disabled="ro.meishiId" filterable placeholder="请选择美食信息" @change="meishiChange">
                            <el-option
                ...
                <el-col :span="24" v-if="sessionTable !='meishi' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.meishiPhoto" label="美食图片" prop="meishiPhoto">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.meishiPhoto" label="美食图片" prop="meishiPhoto">
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="美食数量" prop="meishiNumber">
                        <el-input v-model="meishiForm.meishiNumber"
                                  placeholder="美食数量" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="美食数量" prop="meishiNumber">
                            <el-input v-model="ruleForm.meishiNumber"
                                      placeholder="美食数量" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="价格" prop="meishiMoney">
                        <el-input v-model="meishiForm.meishiMoney"
                                  placeholder="价格" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="价格" prop="meishiMoney">
                            <el-input v-model="ruleForm.meishiMoney"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="预约日期" prop="meishiYuyeTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.meishiYuyeTime"
                                type="date"
                                placeholder="预约日期"
                                :disabled="ro.meishiYuyeTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.meishiYuyeTime" label="预约日期" prop="meishiYuyeTime">
                            <span v-html="ruleForm.meishiYuyeTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="预约备注" prop="meishiYuyeText">
                        <el-input type="textarea"  :readonly="ro.meishiYuyeText" v-model="ruleForm.meishiYuyeText" placeholder="预约备注"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.meishiYuyeText" label="预约备注" prop="meishiYuyeText">
                            <span v-html="ruleForm.meishiYuyeText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    meishiId: false,
                    yonghuId: false,
                    meishiYuyeTime: false,
                    meishiYuyeText: false,
                    meishiYuyeYesnoTypes: false,
                    meishiYuyeYesnoText: false,
                },
                ruleForm: {
                    meishiId: '',
                    yonghuId: '',
                    meishiYuyeTime: '',
                    meishiYuyeText: '',
                    meishiYuyeYesnoTypes: '',
                    meishiYuyeYesnoText: '',
                },
                meishiYuyeYesnoTypesOptions : [],
                meishiOptions : [],
                yonghuOptions : [],
                rules: {
                   meishiId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=meishi_yuye_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.meishiYuyeYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`meishiYuye/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.meishiYuyeCrossAddOrUpdateFlag = false;
                                        this.parent.search();
