    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="反馈内容" prop="fangjianLiuyanText">
                        <el-input type="textarea"  :readonly="ro.fangjianLiuyanText" v-model="ruleForm.fangjianLiuyanText" placeholder="反馈内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.fangjianLiuyanText" label="反馈内容" prop="fangjianLiuyanText">
                            <span v-html="ruleForm.fangjianLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //当前text不能修改
            this.ro.fangjianLiuyanText = true;
            if (this.role != "管理员"){
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`fangjianLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
