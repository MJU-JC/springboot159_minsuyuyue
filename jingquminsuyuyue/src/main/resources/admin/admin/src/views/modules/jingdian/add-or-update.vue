               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="景点价格" prop="jingdianMoney">
                       <el-input v-model="ruleForm.jingdianMoney"
                                 placeholder="景点价格" clearable  :readonly="ro.jingdianMoney"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="景点数量" prop="jingdianNumber">
                       <el-input v-model="ruleForm.jingdianNumber"
                                 placeholder="景点数量" clearable  :readonly="ro.jingdianNumber"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jingdianMoney: [
                              { required: true, message: '景点价格不能为空', trigger: 'blur' },
                   ...
                   jingdianNumber: [
                              { required: true, message: '景点数量不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
