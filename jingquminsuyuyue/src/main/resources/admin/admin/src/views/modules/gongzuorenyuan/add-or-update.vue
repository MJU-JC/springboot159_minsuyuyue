    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工号" prop="gongzuorenyuanUuidNumber">
                       <el-input v-model="ruleForm.gongzuorenyuanUuidNumber"
                                 placeholder="工号" clearable  :readonly="ro.gongzuorenyuanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="工号" prop="gongzuorenyuanUuidNumber">
                           <el-input v-model="ruleForm.gongzuorenyuanUuidNumber"
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.gongzuorenyuanPhoto" label="头像" prop="gongzuorenyuanPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.gongzuorenyuanPhoto?ruleForm.gongzuorenyuanPhoto:''"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="gongzuorenyuanPhone">
                       <el-input v-model="ruleForm.gongzuorenyuanPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.gongzuorenyuanPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="gongzuorenyuanEmail">
                       <el-input v-model="ruleForm.gongzuorenyuanEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.gongzuorenyuanEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="邮箱" prop="gongzuorenyuanEmail">
                           <el-input v-model="ruleForm.gongzuorenyuanEmail"
    ...
    export default {
        data() {
            return {
                ...
                userId:"",//当前登录人的id
                ro:{
                    gongzuorenyuanUuidNumber: false,
                    username: false,
                    password: false,
