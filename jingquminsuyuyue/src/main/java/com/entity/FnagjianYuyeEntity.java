...
public class FnagjianYuyeEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public FnagjianYuyeEntity() {

	}

	public FnagjianYuyeEntity(T t) {
		try {
    ...
    public String toString() {
        return "FnagjianYuye{" +
            ...
            ", yonghuId=" + yonghuId +
            ", fnagjianYuyeTime=" + fnagjianYuyeTime +
            ", fnagjianYuyeText=" + fnagjianYuyeText +
            ", fnagjianTiwen=" + fnagjianTiwen +
            ", fnagjianText=" + fnagjianText +
            ", fnagjianYuyeYesnoTypes=" + fnagjianYuyeYesnoTypes +
            ", fnagjianYuyeYesnoText=" + fnagjianYuyeYesnoText +
