...
public class MeishiYuyeView extends MeishiYuyeEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核结果的值
		*/
		private String meishiYuyeYesnoValue;
	...
	public MeishiYuyeView() {

	}

	public MeishiYuyeView(MeishiYuyeEntity meishiYuyeEntity) {
		try {
			BeanUtils.copyProperties(this, meishiYuyeEntity);
			...
			* 获取： 审核结果的值
			*/
			public String getMeishiYuyeYesnoValue() {
				return meishiYuyeYesnoValue;
			}
			/**
			* 设置： 审核结果的值
			*/
			public void setMeishiYuyeYesnoValue(String meishiYuyeYesnoValue) {
				this.meishiYuyeYesnoValue = meishiYuyeYesnoValue;
			}
