...
public class FnagjianYuyeView extends FnagjianYuyeEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核结果的值
		*/
		private String fnagjianYuyeYesnoValue;
	...
	public FnagjianYuyeView() {

	}

	public FnagjianYuyeView(FnagjianYuyeEntity fnagjianYuyeEntity) {
		try {
			BeanUtils.copyProperties(this, fnagjianYuyeEntity);
			...
			* 获取： 审核结果的值
			*/
			public String getFnagjianYuyeYesnoValue() {
				return fnagjianYuyeYesnoValue;
			}
			/**
			* 设置： 审核结果的值
			*/
			public void setFnagjianYuyeYesnoValue(String fnagjianYuyeYesnoValue) {
				this.fnagjianYuyeYesnoValue = fnagjianYuyeYesnoValue;
			}
